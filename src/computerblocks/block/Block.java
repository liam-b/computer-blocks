...
public abstract class Block {
  ...
  public abstract ArrayList<Block> update(Grid grid, Block updater, Display display, Player player);
  ...
  public void draw(Display display, Player player) {
    double rectSize = BLOCK_SIZE * player.zoom;
    double x = player.drawTranslate.x + BLOCK_RATIO * position.x * player.zoom;
    double y = player.drawTranslate.y + BLOCK_RATIO * position.y * player.zoom;
